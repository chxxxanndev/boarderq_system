...
export default function TenantAnnouncements() {
  ...
  return (
    <div className="flex min-h-screen bg-[#F8FAFC] font-sans text-[#0B1F3B]">
      <main className="flex-1 p-4 sm:p-8 lg:p-12 max-w-6xl mx-auto">

        <div className="flex flex-col md:flex-row md:items-end gap-4 mb-8 sm:mb-12">
          <div>
          ...
          <div className="flex-1 h-[2px] bg-[#E5E7EB] mb-2 hidden md:block" />
        </div>
              ...
              <div key={ann.id} className="bg-white border border-[#E5E7EB] rounded-2xl overflow-hidden group hover:border-[#1E5EFF] transition-all shadow-sm">
                <div className="p-5 sm:p-8 flex flex-col sm:flex-row gap-5 sm:gap-8 items-start">
                  ...
                  <div className="flex-1 w-full">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 gap-3 border-b border-[#E5E7EB] pb-4 sm:pb-5">
                      <div>
                      ...
                      <div className="text-[10px] sm:text-[11px] text-[#0B1F3B] font-black flex items-center gap-2 uppercase tracking-widest bg-[#F8FAFC] px-3 sm:px-4 py-2 rounded-lg border border-[#E5E7EB] self-start sm:self-auto">
          ...
          {selectedAnnouncement && (
            <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
              ...
              >
                ...
                <div className="px-6 sm:px-10 py-6 sm:py-8 flex justify-between items-center border-b border-gray-100 bg-[#F8FAFC]">
                  ...
                  <button
                    onClick={() => setSelectedAnnouncement(null)}
                    className="text-gray-400 hover:text-[#0B1F3B] transition-colors p-2 hover:bg-gray-200 rounded-full"
                  >
                    <X size={24} />
                  </button>
                </div>
