      ...
      <main className="flex-1 p-8 lg:p-12">
        ...
        <div className="w-full flex items-center gap-6 mb-12">
          <div className="bg-emerald-500/10 border border-emerald-500/20 px-6 py-2 rounded-sm shrink-0 shadow-sm">
            <span className="text-emerald-700 font-black text-[11px] tracking-[0.3em] uppercase">
              INVENTORY MODULE
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {mockRooms.map((room) => (
            <div key={room.id} className="group bg-white border border-slate-200 shadow-sm hover:border-cyan-500/40 transition-all flex flex-col relative overflow-hidden glass-panel">
              ...
              <div className={`absolute top-0 right-0 px-4 py-1.5 text-[9px] font-black uppercase tracking-tighter z-10 text-white shadow-sm ${
              ...
              <div className="border-t border-slate-100 p-5 flex justify-between items-center bg-slate-50/50 mt-auto">
                <div className="flex gap-6">
                  <button className="text-[10px] font-black uppercase text-slate-400 hover:text-cyan-600 tracking-widest transition-all">
                    Modify
                  </button>
                  <button className="text-[10px] font-black uppercase text-slate-400 hover:text-rose-600 tracking-widest transition-all">
                    Archive
                  </button>
                </div>
                <button className="flex items-center gap-1 text-[10px] font-black uppercase text-cyan-600 hover:translate-x-1 transition-all tracking-widest">
          ...
          <button className="border-2 border-dashed border-slate-200 p-8 flex flex-col items-center justify-center gap-4 hover:border-cyan-500/50 hover:bg-white transition-all group min-h-[350px]">
            ...
            <div className="text-center">
              <span className="block text-[11px] font-black text-slate-800 tracking-[0.2em] uppercase">Register Unit</span>
