...
export default function Navbar() {
  ...
  if (!role) {
    ...
    navLinks = [
      { name: 'Dashboard', href: '/admin/dashboard' }, // Ensure these match your folder structure
...
// export default function Navbar() {
//   const pathname = usePathname();
//   const { isDarkMode, toggleTheme } = useTheme(); // 👈 pull from context
//   const [role, setRole] = useState(null);
...
//   // 👇 delete the old toggleTheme function entirely — it's now in context
...
//       case 'Maintenance': return <Wrench className={iconClass} />;
//       case 'Announcements': return <Megaphone className={iconClass} />;
//       case 'About': return <Info className={iconClass} />;
//       default: return <LayoutDashboard className={iconClass} />;
//     }
//   };
